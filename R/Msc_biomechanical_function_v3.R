...
# Turn each outline into the measurements used later in the pipeline.
...
calculate_von_mises_stress <- function(outline_coords, mass_kg, wingspan_cm) {
  # Use safe default body-size values when a specimen is missing them.
  ...
  # Divide by overall size so large and small animals can be compared.
...
# --------------------------------------------------------------------------------
# 5. Keep this older helper for reference in the methods text
# --------------------------------------------------------------------------------
