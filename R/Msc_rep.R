...
# --- Build the shape analysis once, then reuse it for all figures. ------------
...
# --- Shared helper functions for hulls, silhouettes, and reconstructions. -----
...
# Place the real wing outlines at chosen x and y positions.
...
# Rebuild a theoretical wing shape from chosen PC scores.
...
# --- FIGURE 1: draw the real wings at their shape-space positions. ------------
...
# --- FIGURE 2: draw a grid of theoretical wings behind the specimen points. ---
...
# --- FIGURE 3: draw a denser theoretical grid with the sample overlaid. ------
