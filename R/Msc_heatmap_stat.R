# Test which categorical factors tend to occur together.
...
# Start from the cleaned performance table.
...
# List the factor pairs to compare. Missing columns are dropped later.
PAIRS <- list(
...
# --------------------------------------------------------------------------------
# Summarise all factor-to-factor tests
# --------------------------------------------------------------------------------
