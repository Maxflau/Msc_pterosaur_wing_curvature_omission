...
- `data/` — the only two raw inputs required to run the pipeline:
  - `pteros_main_data.csv` — is the csv file containing all the palaeobiological, geomorphological and temporal informations of the specimen used in this study.
