# ============================================================
# SCRIPT PRINCIPAL - lance toute l'analyse d'un seul coup.
# Il suffit d'exécuter ce fichier : chaque ligne "source(...)"
# ci-dessous charge et exécute un module de la pipeline, dans
# l'ordre exact requis (ne pas changer cet ordre).
# ============================================================
rm(list=ls()) # vide la mémoire de R avant de commencer
# Se place automatiquement dans le dossier du dépôt (si ouvert dans RStudio)
if (requireNamespace("rstudioapi", quietly = TRUE) && rstudioapi::isAvailable()) {
  setwd(dirname(rstudioapi::getSourceEditorContext()$path))
}
# --- 1. Outils de base : packages et fonctions communes ---
source("R/Msc_librairies.R")
source("R/Msc_biomechanical_function_v3.R")
# --- 2. Arbre phylogénétique et données des spécimens ---
source("R/Msc_tree_creation.R")
source("R/Msc_data_handling.R")
# --- 3. Contours des ailes (outlines) ---
source("R/Msc_outline_extract_1.R")
source("R/Msc_outline_loading.R")
source("R/Msc_orien_v1.R")
# --- 4. Calcul des performances de vol et des espaces théoriques ---
...
# --- 5. Figures et visualisations générales ---
...
# --- 8. Statistiques par clade et PCA ---
...
# --- 11. Analyse de forme des contours (EFA) ---
...
# --- 12. Résultats finaux (morphospace, classification des ailes, PGLS) ---
